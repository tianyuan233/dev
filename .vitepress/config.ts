  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { text: "HTTP", link: "/network/http-base" },
      ],
    },
    {
      text: "开发工具",
...
function sidebarVue() {
  return [
    {
      text: "Vue2",
      items: [{ text: "插件", link: "/vue/plugin" }],
    },
    {
      text: "Vue3",
      items: [{ text: "基础", link: "/vue/vue3-start.md" }],
    },
  ];
}
...
function sidebarReact() {
  return [
    {
      text: "React Learning",
      items: [{ text: "基础", link: "/react/base" }],
    },
    {
      text: "Hooks",
      items: [{ text: "useMemo", link: "/react/hooks-useMemo" }],
    },
  ];
}
...
function sidebarTool() {
  return [
    ...
    {
      text: "VS Code",
      items: [{ text: "VS Code", link: "/tool/vscode.md" }],
    },
    {
      text: "常用工具和配置",
      items: [
